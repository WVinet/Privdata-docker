package com.example.demo.arsop.solicitudesAdicionales.bloqueo;
...
public class BloqueoTemporalService {
    ...
    public ArcoRequest crear(ArcoRequestCreateDTO dto) {
        ...
        // Art. 8° ter: bloqueo inmediato del tratamiento mientras se resuelve la solicitud relacionada
        try {
